      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-10 py-10">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <a href="https://instagram.com/padelup" aria-label="Instagram" className="w-8 h-8 flex items-center justify-center rounded-full text-white/30 hover:text-white/60 transition-colors">
            ...
            <a href="https://x.com/padelup" aria-label="X" className="w-8 h-8 flex items-center justify-center rounded-full text-white/30 hover:text-white/60 transition-colors">
            ...
            <a href="https://tiktok.com/@padelup" aria-label="TikTok" className="w-8 h-8 flex items-center justify-center rounded-full text-white/30 hover:text-white/60 transition-colors">
              <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <p className="text-center text-xs text-white/15 mt-8">&copy; 2026 PadelUp</p>
      </div>
    </footer>
  );
}
