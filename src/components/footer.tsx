...
export default function Footer() {
  return (
    <footer className="w-full mt-auto border-t border-white/[0.06] bg-[#050505]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6 flex-wrap justify-center">
            ...
            <a href="mailto:support@trypadelup.com" className="text-sm text-white/50 hover:text-white/80 transition-colors">
              Contact
            </a>
          </div>
        ...
        <div className="mt-8 pt-6 text-center text-xs border-t border-white/[0.04] text-white/30">
