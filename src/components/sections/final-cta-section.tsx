...
export default function FinalCta() {
  return (
    <section className="relative py-32 px-4 text-center overflow-hidden bg-[#050505] noise-bg">
      {/* Gradient orbs */}
      ...
      <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center gap-6">
        ...
        <a
          href={APP_STORE_URL}
          className="flex items-center gap-3 px-10 py-4 rounded-full font-semibold text-lg bg-teal text-[#050505] animate-pulse-glow hover:scale-[1.02] transition-transform mt-4"
        >
